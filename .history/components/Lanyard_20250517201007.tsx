...
// You need a global.d.ts file with meshline and asset module declarations for full TS support.
...
function Band({ maxSpeed = 50, minSpeed = 0 }: BandProps) {
    ...
    // Type the GLTF and texture results
