  ...
  return (
    <div>
      ...
      <div className="sectionTwo overflow-hidden h-screen relative  flex flex-col items-end pr-50 justify-center">
        ...
        <div className="flex relative w-full h-screen gap-10 justify-between items-center px-50  ">
          <iframe  src='https://my.spline.design/genkubgreetingrobot-vF5wr14MHrE7chv3zCNBjOzW/' frameborder='0' width='100%' height='100%'></iframe>
