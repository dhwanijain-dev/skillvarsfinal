...
const page = () => {
  ...
  const [starOffset, setStarOffset] = useState<[number, number, number]>([0, 0, 0]);
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    // Adjust the multiplier for desired parallax strength
    setStarOffset([x * 2, -y * 2, 0]);
  };
