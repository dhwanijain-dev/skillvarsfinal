...
const page = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const serviceId = "service_1809cc8"; // Replace with your EmailJS service ID
      const templateId = "template_1h5oymw"; // Replace with your EmailJS template ID
      const userId = "mDRw5a4iq-le1c7jwlAk0"; // Replace with your EmailJS user ID
