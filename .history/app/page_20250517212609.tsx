      ...
      <div className="sectionOne relative h-screen gap-10 flex flex-col items-center justify-center">
        <Canvas className="w-full h-screen absolute" camera={{ position: [0, 0, 15], fov: 50 }}>
          ...
          <mesh>
            ...
            <meshStandardMaterial color="#1DCBE5" />
          </mesh>

          
          <OrbitControls enableZoom={false} autoRotate autoRotateSpeed={0.5} />
        </Canvas>
        <h1 className="text-7xl great-vibes-regular absolute translate-x-1/2 bg-gradient-to-r from-[#1DCBE5] to-[#FF6B35] pt-2 pr-2 bg-clip-text text-transparent">Devistic</h1>
        <p className="text-3xl text-[#1DCBE5] absolute">Where Development meets Artistry</p>
      </div>
