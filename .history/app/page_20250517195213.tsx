      ...
      <div className="sectionFour h-screen relative w-full flex flex-col items-center justify-center" >
        ...
        <div>
          <form className="flex flex-col gap-3 items-center justify-center">
            <input type="text" placeholder="Name" className="border-2 w-full border-[#1DCBE5] rounded-md p-2" />
            <input type="email" placeholder="Email" className="border-2 w-full border-[#1DCBE5] rounded-md p-2" />
