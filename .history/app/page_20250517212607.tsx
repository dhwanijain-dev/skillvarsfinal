  ...
  return (
    <div>
      ...
      <div className="sectionOne relative h-screen gap-10 flex flex-col items-center justify-center">
        ...
        <h1 className="text-7xl great-vibes-regular absolute translate bg-gradient-to-r from-[#1DCBE5] to-[#FF6B35] pt-2 pr-2 bg-clip-text text-transparent">Devistic</h1>
