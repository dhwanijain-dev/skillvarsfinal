  ...
  return (
    <div>
      ...
      <div className="sectionFour h-screen relative w-full flex flex-col items-center justify-center" >
        ...
        <div>
          <form className="flex flex-col gap- items-center justify-center">
              ...
              <textarea placeholder="Message" className="border-2 border-[#1DCBE5] rounded-md p-2 h-32"></textarea>
              <button type="submit" className="bg-[#1DCBE5] text-white rounded-md p-2">Send</button>
          </form>
        </div>
      </div>
    </div>
