...
const page = () => {
  ...
  const paintbrush = useGLTF("/paintbrush.glb");
  ...
  return (
    <div>
      ...
      <div className="sectionFour h-screen relative w-full flex flex-col items-center justify-center" >
        ...
        <div className="flex relative w-full h-screen px-50  ">
          ...
          <iframe height='100%' width='100%' src='https://my.spline.design/nexbotrobotcharacterconcept-3c2e5832dc847143bda8952d230b49ee/' ></iframe>
        </div>
